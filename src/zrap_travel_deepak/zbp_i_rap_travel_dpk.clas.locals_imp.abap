CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    DATA agencies TYPE SORTED TABLE OF /dmo/agency WITH UNIQUE KEY
  agency_id.
    ...
    METHODS validAgency FOR VALIDATE ON SAVE
      IMPORTING keys FOR Travel~validAgency.

    METHODS validateCustomer FOR VALIDATE ON SAVE
      IMPORTING keys FOR Travel~validateCustomer.

    METHODS validDates FOR VALIDATE ON SAVE
      IMPORTING keys FOR Travel~validDates.
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_features.
    ...
    READ ENTITIES OF zi_rap_travel_dpk IN LOCAL MODE
    ENTITY Travel
  ...
  METHOD acceptTravel.
    ...
    MODIFY ENTITIES OF zi_rap_travel_dpk IN LOCAL MODE
    ENTITY Travel
    UPDATE
    FIELDS ( TravelStatus )
  ...
  METHOD validAgency.
   ...
   agency_id = AgencyID EXCEPT * ).
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      TO reported-travel.
      IF travel-AgencyID IS INITIAL OR NOT line_exists( agencies_db[
  ...
  METHOD validateCustomer.
   ...
   customer_id = CustomerID EXCEPT * ).
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      TO reported-travel.
      IF travel-CustomerID IS INITIAL OR NOT line_exists( customers_db[
  ...
  METHOD validDates.
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      ELSEIF travel-BeginDate < cl_abap_context_info=>get_system_date( ).
       ...
       if_abap_behv_message=>severity-error
        textid =
       zcm_rap_dpk=>begin_date_before_system_date
        begindate = travel-BeginDate )
